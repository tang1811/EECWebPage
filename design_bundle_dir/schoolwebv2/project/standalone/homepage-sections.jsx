...
function HeroCrest({ py }) {
  return (
    <div className="hero-crest" style={{ transform: `translateY(${py * -0.15}px)` }}>
      ...
      <img src={window.__getAsset('assets/logo.png')} alt="EEC Engineer Laemchabang crest" className="crest-logo"/>
...
const SLIDES = [
  {
    key: 'apply',
    img: window.__getAsset('assets/slide-1-apply.webp'),
  ...
  {
    key: 'eec',
    img: window.__getAsset('assets/slide-2-eec.webp'),
  ...
  {
    key: 'innovation',
    img: window.__getAsset('assets/slide-3-innovation.webp'),
  ...
  {
    key: 'community',
    img: window.__getAsset('assets/slide-4-community.webp'),
...
// ── COURSES ─────────────────────────────────────────────────
const COURSES = [
  { code: 'ปวช.', slug: 'yon',           name: 'ช่างยนต์',                 icon: 'car',       cat: 'อุตสาหกรรม', hot: true, img: window.__getAsset('assets/courses/yon.webp'),              color: '#B12B25' },
  { code: 'ปวช.', slug: 'faifaa',        name: 'ช่างไฟฟ้ากำลัง',           icon: 'bolt',      cat: 'อุตสาหกรรม', hot: true, img: window.__getAsset('assets/courses/faifaa.webp'),           color: '#40ABE0' },
  { code: 'ปวช.', slug: 'gear',          name: 'ช่างกลโรงงาน',             icon: 'gear',      cat: 'อุตสาหกรรม',            img: window.__getAsset('assets/courses/gear.webp'),             color: '#FBD609' },
  { code: 'ปวช.', slug: 'electronic',    name: 'อิเล็กทรอนิกส์',           icon: 'chip',      cat: 'อุตสาหกรรม',            img: window.__getAsset('assets/courses/electronic.webp') },
  { code: 'ปวช.', slug: 'mecha',         name: 'เมคคาทรอนิกส์และหุ่นยนต์', icon: 'robot',     cat: 'อุตสาหกรรม', hot: true, img: window.__getAsset('assets/courses/mecha.webp'),            color: '#FBDC6B' },
  { code: 'ปวช.', slug: 'graphic',       name: 'ดิจิทัลกราฟิก',            icon: 'palette',   cat: 'ดิจิทัล',               img: window.__getAsset('assets/courses/digital-graphic.webp'),  color: '#385BF3' },
  { code: 'ปวช.', slug: 'biz-digital',   name: 'เทคโนโลยีธุรกิจดิจิทัล',   icon: 'chart',     cat: 'บริหาร',                img: window.__getAsset('assets/courses/digital-business.webp'), color: '#EB559F' },
  { code: 'ปวช.', slug: 'accounting',    name: 'การบัญชี',                 icon: 'briefcase', cat: 'บริหาร',                img: window.__getAsset('assets/courses/accounting.webp'),       color: '#7B5CA7' },
  { code: 'ปวส.', slug: 'ps-mech',       name: 'เทคนิคเครื่องกล',          icon: 'car',       cat: 'อุตสาหกรรม',            img: window.__getAsset('assets/courses/ps-mechanical.webp'),    color: '#B12B25' },
  { code: 'ปวส.', slug: 'ps-electrical', name: 'ไฟฟ้า',                    icon: 'bolt',      cat: 'อุตสาหกรรม',            img: window.__getAsset('assets/courses/ps-electrical.webp'),    color: '#40ABE0' },
  { code: 'ปวส.', slug: 'ps-production', name: 'เทคนิคการผลิต',            icon: 'gear',      cat: 'อุตสาหกรรม',            img: window.__getAsset('assets/courses/ps-production.webp'),    color: '#FBD609' },
  { code: 'ปวส.', slug: 'ps-mecha',      name: 'เมคคาทรอนิกส์และหุ่นยนต์', icon: 'robot',     cat: 'อุตสาหกรรม',            img: window.__getAsset('assets/courses/ps-mecha.webp'),         color: '#FBDC6B' },
  { code: 'ปวส.', slug: 'ps-network',    name: 'เครือข่ายคอมฯ & ความปลอดภัย', icon: 'network', cat: 'ดิจิทัล',             img: window.__getAsset('assets/courses/ps-network.webp'),       color: '#EB559F' },
  { code: 'ปวส.', slug: 'ps-graphic',    name: 'ดิจิทัลกราฟิก',            icon: 'palette',   cat: 'ดิจิทัล',               img: window.__getAsset('assets/courses/ps-graphic.webp'),       color: '#385BF3' },
  { code: 'ปวส.', slug: 'ps-logistics',  name: 'การจัดการโลจิสติกส์',      icon: 'truck',     cat: 'บริหาร',  hot: true,    img: window.__getAsset('assets/courses/ps-logistics.webp'),     color: '#F26530' },
  { code: 'ปวส.', slug: 'ps-accounting', name: 'การบัญชี',                 icon: 'briefcase', cat: 'บริหาร',                img: window.__getAsset('assets/courses/ps-accounting.webp'),    color: '#7B5CA7' },
  { code: 'ปวส.', slug: 'ps-electronic', name: 'อิเล็กทรอนิกส์',           icon: 'chip',      cat: 'อุตสาหกรรม',            img: window.__getAsset('assets/courses/ps-electronic.webp') },
  { code: 'ปวส.', slug: 'ps-industrial', name: 'เทคนิคอุตสาหกรรม',         icon: 'shield',    cat: 'อุตสาหกรรม',            img: window.__getAsset('assets/courses/ps-industrial.webp') },
];
...
function Highlights() {
  const news = [
    { tag: 'กิจกรรม', t: 'กิจกรรมสานสัมพันธ์ 69 (รอบเช้า)', d: 'วันที่ 20 พฤษภาคม 2569 ต้อนรับนักศึกษาใหม่', img: window.__getAsset('assets/news-1-sansamphan-morning.webp'), objectPosition: 'center 28%' },
    { tag: 'กิจกรรม', t: 'กิจกรรมสานสัมพันธ์ 69 (รอบบ่าย)', d: 'มิตรภาพดีด้วยรอยยิ้มและเสียงหัวเราะ', img: window.__getAsset('assets/news-2-sansamphan-afternoon.webp'), objectPosition: 'center 50%' },
    { tag: 'นศท.', t: 'ทดสอบสมรรถภาพทางกาย นศท.', d: 'นักศึกษาวิชาทหาร ปีที่ 1 ประจำปีการศึกษา 2569', img: window.__getAsset('assets/news-3-military.webp'), objectPosition: 'center 18%' },
  ];
  return (
